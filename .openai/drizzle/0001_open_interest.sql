...
CREATE INDEX IF NOT EXISTS idx_oi_summary_date
  ON occ_daily_summaries(contract_date DESC);
CREATE INDEX IF NOT EXISTS idx_oi_levels_history
  ON occ_contract_levels(symbol,contract_date DESC);
